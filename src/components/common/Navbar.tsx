        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="flex items-center">
              <Image src="/logo2.png" alt="Logo" width={210} height={160} />
            </Link>
          </div>
          ...
          <div className="hidden md:flex text-lg items-center ">
            <div className="flex  text-lg">
              <Link 
                ...
                className={`px-3 py-2 font-bold transition-all duration-300 ${
                  activeLink === 'courses' 
                    ? 'text-indigo-600 border-b-2 border-indigo-600 shadow-[0_4px_6px_-1px_rgba(79,70,229,0.1)]' 
                    : 'text-blue-500 hover:text-indigo-800 hover:border-b-2 hover:border-indigo-100'
                }`}
            ...
            <div className="ml-4 flex items-center border-2 border-blue-500 rounded-full px-4 py-2 hover:border-green-500 hover:text-green-500 hover:bg-green-50 transition-colors duration-200 space-x-3">
             
              <Link 
                href="https://wa.me/your-whatsapp-number" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-600 flex items-center gap-2 hover:text-green-500 hover:border-green-500 hover:bg-green-50 transition-colors duration-200"
                aria-label="WhatsApp"
                >
              ...
              <span className="text-green-500 text-lg">
                ...
                <span className="text-blue-500 hover:text-green-500 hover:border-green-500 hover:bg-green-50 transition-colors duration-200 text-lg">Contact us</span>
              </Link>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/courses" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50">
              Courses
            </Link>
            <Link href="/services" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50">
              Services
            </Link>
